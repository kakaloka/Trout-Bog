...
```
Where (*)potential_NIFH are the output of the step 4, info_and_taxo.csv is the taxonomical mapping file and i.output are the output of the script [a relative link](./perl_script_to_get_taxonomy_abundances.pl)
